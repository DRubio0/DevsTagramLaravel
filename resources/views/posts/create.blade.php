...
@section('contenido')
    <div class="md:flex md:items-center">
        ...
        <div class="md:w-1/2 mr-5 p-10 bg-white rounded-lg shadow-xl mt-10 md:mt-0">
            <form action="{{ route('post.store') }}" method="POST" novalidate>
                @csrf
                <div class="mb-5">
                    <label class="mb-2 block uppercase text-gray-500 font-bold" for="titulo">Nombre
                    </label>
                ...
                <div class="mb-5">
                    <label class="mb-2 block uppercase text-gray-500 font-bold" for="descripcion">Descripcion
                    </label>
